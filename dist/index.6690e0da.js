...
var _createAppJs = require("./modules/createApp.js");
...
(0, _redom.mount)(document.body, (0, _createAppJs.createApp)());
(0, _listenersJs.listeners)();
(0, _validateDefault.default)();

},{"./modules/createApp.js":"ebeNt","redom":"iahd6","./modules/listeners.js":"f2v3B","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./modules/validate":"e9TAy"}],"ebeNt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createApp", ()=>createApp);
var _redomEsJs = require("../../node_modules/redom/dist/redom.es.js");
const createApp = ()=>{
    const wrapper = (0, _redomEsJs.el)(".wrapper");
    const creditCard = (0, _redomEsJs.el)(".credit-card");
    const cardNumber = (0, _redomEsJs.el)("span.card__number", "xxxx xxxx xxxx xxxx");
    const cardPersonal = (0, _redomEsJs.el)(".card__personal", (0, _redomEsJs.el)("span.card__name", {
        textContent: "John Doe"
    }), (0, _redomEsJs.el)("span.card__date", "04/24"));
    (0, _redomEsJs.setChildren)(creditCard, cardNumber, cardPersonal);
    // Форма
    const form = (0, _redomEsJs.el)("form", {
        className: "form",
        action: "#",
        id: "form"
    });
    const cardHolderInput = (0, _redomEsJs.el)(".form__input-wrap form__input-wrap_holder", (0, _redomEsJs.el)("label.form__label form__holder-label", "Card Holder"), (0, _redomEsJs.el)("input", {
        className: "input input__holder",
        type: "text",
        name: "name"
    }));
    const holderValidate = (0, _redomEsJs.el)("h2.holder-validate");
    const cardNumberInput = (0, _redomEsJs.el)(".form__input-wrap form__input-wrap_number", (0, _redomEsJs.el)("label.form__label form__number-label", "Card Number"), (0, _redomEsJs.el)("input", {
        className: "input input__number",
        id: "cardNumber",
        name: "number"
    }));
    const numberValidate = (0, _redomEsJs.el)("h2.number-validate");
    const cardExpiryInput = (0, _redomEsJs.el)(".form__input-wrap form__input-wrap_date", (0, _redomEsJs.el)("label.form__label form__date-label", "Card Expiry"), (0, _redomEsJs.el)("input", {
        className: "input input__date",
        type: "text"
    }));
    const cardCvvInput = (0, _redomEsJs.el)(".form__input-wrap form__input-wrap_cvv", (0, _redomEsJs.el)("label.form__label form__cvv-label", "CVV"), (0, _redomEsJs.el)("input", {
        className: "input input__cvv",
        type: "text",
        maxLength: 3,
        name: "cvv"
    }));
    const cvvValidate = (0, _redomEsJs.el)("h2.cvv-validate");
    const button = (0, _redomEsJs.el)("button.form__button", "CHECK OUT");
    (0, _redomEsJs.setChildren)(form, cardHolderInput, holderValidate, cardNumberInput, numberValidate, cardExpiryInput, cardCvvInput, cvvValidate, button);
    const card = (0, _redomEsJs.el)(".card", [
        (0, _redomEsJs.el)("p.secure", "Secure Checkout"),
        creditCard,
        form
    ]);
    (0, _redomEsJs.mount)(wrapper, card);
    return wrapper;
};

},{"../../node_modules/redom/dist/redom.es.js":"iahd6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iahd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"f2v3B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "listeners", ()=>listeners);
...
const listeners = ()=>{
    ...
    const holderMask = new (0, _inputmaskDefault.default)("9999 9999 9999 9999");
    const cvvMask = new (0, _inputmaskDefault.default)("999");
    cardHolderInput.addEventListener("input", ()=>{
        cardHolderInput.value = cardHolderInput.value.replace(/(^[\s-])|([^a-z\s-])/i, "");
        cardHolder.textContent = cardHolderInput.value;
        if (cardHolderInput.value === "") cardHolder.textContent = "John Doe";
    });
    cardNumberInput.addEventListener("input", ()=>{
        ...
        if (cardNumberInput.value === "") cardNumber.textContent = "xxxx xxxx xxxx xxxx";
    });
    cardExpiryInput.addEventListener("input", ()=>{
        ...
        if (cardExpiryInput.value === "") cardDate.textContent = "04/24";
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kmSpe","2OpUZ"], "2OpUZ", "parcelRequire7921")
